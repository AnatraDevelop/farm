// ID Spreadsheet sebaiknya TIDAK di-hardcode saat kode disimpan di repo publik (GitHub).
// Set melalui: Project Settings > Script Properties > key "SPREADSHEET_ID" di editor Apps Script.
// Jika belum diset, kode ini otomatis memakai nilai fallback di bawah (ID lama).
...
function getSpreadsheetId_() {
  ...
  return '11rk7ZKuIXxwjMLWqyec2O2l_Cmo5d5QbEtSfA-PNWIc'; // fallback (opsional dihapus setelah Script Properties diset)
}
